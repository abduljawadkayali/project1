...
class ExamsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('exam/create')->with('success', 'Data Added successfully.');
    }
    ...
    return redirect('exam')->with('success', 'Data Edited successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        $data->delete();
        return redirect('exam')->with('success', 'Data Deleted successfully.');
    }
}
