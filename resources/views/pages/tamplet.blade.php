...
<html>
  <head>
    ...
    <link rel="apple-touch-icon" href="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/apple-touch-icon.png">
    <link rel="apple-touch-icon" sizes="57x57" href="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/apple-touch-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="72x72" href="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/apple-touch-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/apple-touch-icon-114x114.png">
    ...
    <div id="all">
      ...
      <header class="nav-holder make-sticky">
        <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
          <div class="container"><a href="index.html" class="navbar-brand home"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/logo.png" alt="Universal logo" class="d-none d-md-inline-block"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/logo-small.png" alt="Universal logo" class="d-inline-block d-md-none"><span class="sr-only">Universal - go to homepage</span></a>
              ...
              <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Features<b class="caret"></b></a>
                  <ul class="dropdown-menu megamenu">
                    <li>
                      <div class="row">
                        <div class="col-lg-6"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/template-easy-customize.png" alt="" class="img-fluid d-none d-lg-block"></div>
                ...
                <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Portfolio <b class="caret"></b></a>
                  <ul class="dropdown-menu megamenu">
                    <li>
                      <div class="row">
                        <div class="col-lg-6"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/template-homepage.png" alt="" class="img-fluid d-none d-lg-block"></div>
                        <div class="col-lg-3 col-md-6">
                          <h5>Portfolio</h5>
                          <ul class="list-unstyled mb-3">
      ...
      <section style="background: url('https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/photogrid.jpg') center center repeat; background-size: cover;" class="bar background-white relative-positioned">
        <div class="container">
          <!-- Carousel Start-->
              ...
              <div class="homepage owl-carousel">
                <div class="item">
                  <div class="row">
                    <div class="col-md-5 text-right">
                      <p><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/logo.png" alt="" class="ml-auto"></p>
                      <h1>Multipurpose responsive theme</h1>
                      <p>Business. Corporate. Agency.<br>Portfolio. Blog. E-commerce.</p>
                    </div>
                    <div class="col-md-7"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/template-homepage.png" alt="" class="img-fluid"></div>
                  </div>
                </div>
                <div class="item">
                  <div class="row">
                    <div class="col-md-7 text-center"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/template-mac.png" alt="" class="img-fluid"></div>
                    <div class="col-md-5">
                ...
                <div class="item">
                  <div class="row">
                    ...
                    <div class="col-md-7"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/template-easy-customize.png" alt="" class="img-fluid"></div>
                  </div>
                </div>
                <div class="item">
                  <div class="row">
                    <div class="col-md-7"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/template-easy-code.png" alt="" class="img-fluid"></div>
                    <div class="col-md-5">
              ...
              <div class="testimonial d-flex flex-wrap">
                ...
                <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                  ...
                  <div class="testimonial-info d-flex">
                    ...
                    <div class="avatar"><img alt="" src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/person-1.jpg" class="img-fluid"></div>
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class="testimonial d-flex flex-wrap">
                ...
                <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                  ...
                  <div class="testimonial-info d-flex">
                    ...
                    <div class="avatar"><img alt="" src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/person-2.jpg" class="img-fluid"></div>
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class="testimonial d-flex flex-wrap">
                ...
                <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                  ...
                  <div class="testimonial-info d-flex">
                    ...
                    <div class="avatar"><img alt="" src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/person-3.png" class="img-fluid"></div>
                  </div>
                </div>
              </div>
            </li>
              ...
              <div class="testimonial d-flex flex-wrap">
                ...
                <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                  ...
                  <div class="testimonial-info d-flex">
                    ...
                    <div class="avatar"><img alt="" src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/person-4.jpg" class="img-fluid"></div>
                  </div>
                </div>
              </div>
            </li>
      ...
      <section style="background: url(https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/fixed-background-2.jpg) center top no-repeat; background-size: cover;" class="bar no-mb color-white text-center bg-fixed relative-positioned">
          ...
          <div class="row">
            <div class="col-lg-3">
              <div class="home-blog-post">
                <div class="image"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/portfolio-4.jpg" alt="..." class="img-fluid">
            ...
            <div class="col-lg-3">
              <div class="home-blog-post">
                <div class="image"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/portfolio-3.jpg" alt="..." class="img-fluid">
                  <div class="overlay d-flex align-items-center justify-content-center"><a href="#" class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
                </div>
                <div class="text">
            ...
            <div class="col-lg-3">
              <div class="home-blog-post">
                <div class="image"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/portfolio-5.jpg" alt="..." class="img-fluid">
                  <div class="overlay d-flex align-items-center justify-content-center"><a href="#" class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
                </div>
                <div class="text">
            ...
            <div class="col-lg-3">
              <div class="home-blog-post">
                <div class="image"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/portfolio-6.jpg" alt="..." class="img-fluid">
                  <div class="overlay d-flex align-items-center justify-content-center"><a href="#" class="btn btn-template-outlined-white"><i class="fa fa-chain"> </i> Read More</a></div>
                </div>
                <div class="text">
                  <h4><a href="#">Fashion Now </a></h4>
      ...
      <section class="bar bg-gray">
        <div class="container">
          ...
          <ul class="list-unstyled owl-carousel customers no-mb">
            <li class="item"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/customer-1.png" alt="" class="img-fluid"></li>
            <li class="item"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/customer-2.png" alt="" class="img-fluid"></li>
            <li class="item"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/customer-3.png" alt="" class="img-fluid"></li>
            <li class="item"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/customer-4.png" alt="" class="img-fluid"></li>
            <li class="item"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/customer-5.png" alt="" class="img-fluid"></li>
            <li class="item"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/customer-6.png" alt="" class="img-fluid"></li>
          </ul>
        </div>
      </section>
      <!-- GET IT-->
          ...
          <div class="row">
            ...
            <div class="col-lg-3">
              ...
              <ul class="list-unstyled footer-blog-list">
                <li class="d-flex align-items-center">
                  <div class="image"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/detailsquare.jpg" alt="..." class="img-fluid"></div>
                  <div class="text">
            ...
            <div class="col-lg-3">
              <ul class="list-inline photo-stream">
                <li class="list-inline-item"><a href="#"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/detailsquare.jpg" alt="..." class="img-fluid"></a></li>
                <li class="list-inline-item"><a href="#"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/detailsquare2.jpg" alt="..." class="img-fluid"></a></li>
                <li class="list-inline-item"><a href="#"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/detailsquare3.jpg" alt="..." class="img-fluid"></a></li>
                <li class="list-inline-item"><a href="#"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/detailsquare3.jpg" alt="..." class="img-fluid"></a></li>
                <li class="list-inline-item"><a href="#"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/detailsquare2.jpg" alt="..." class="img-fluid"></a></li>
                <li class="list-inline-item"><a href="#"><img src="https://d19m59y37dris4.cloudfront.net/universal/2-0-2/img/detailsquare.jpg" alt="..." class="img-fluid"></a></li>
              </ul>
      ...
      <button type="button" data-toggle="collapse" data-target="#style-switch" id="style-switch-button" class="btn btn-primary hidden-xs hidden-sm"><i class="fa fa-cog fa-2x"></i></button>
      <div id="style-switch" class="collapse">
        ...
        <h4 class="text-uppercase">Select theme layout</h4>
        <form class="mb-3">
